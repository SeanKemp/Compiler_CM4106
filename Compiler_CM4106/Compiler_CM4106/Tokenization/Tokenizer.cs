    ...
    public class Tokenizer
    {
        ...
        private TokenType ScanToken()
        {
            ...
            if (Char.IsLetter(Reader.Current)) // Identifier
            {
                ...
                {
                    Reporter.RecordError($"Identifier must have a letter or digit after first letter", Reader.CurrentPosition);
            ...
            else if (Char.IsDigit(Reader.Current)) // Integer Literal
            {
            ...
            else if (Reader.Current.Equals('"')) // Character Literal
            {
                TakeIt();
                if (Char.IsLetterOrDigit(Reader.Current) ||
                    IsOperator(Reader.Current) || Reader.Current.Equals(' '))
                {
                    TakeIt();
