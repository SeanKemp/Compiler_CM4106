    ...
    public static class TreePrinter
    {
        ...
        private static string ToString(ImmutableList<bool> lastChild, IAbstractSyntaxTreeNode node)
        {
            switch (node)
            {
                ...
                case WhileForeverCommandNode whileForeverCommand:
                    return NodeToString(lastChild, whileForeverCommand, whileForeverCommand.Command);

                case ForCommandNode forCommand:
                    return NodeToString(lastChild, forCommand, forCommand.FirstCommand, forCommand.Expression, forCommand.SecondCommand, forCommand.DoCommand);
